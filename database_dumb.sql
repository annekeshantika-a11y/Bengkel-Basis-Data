...
-- 1. PELANGGAN
-- ============================================================
INSERT INTO pelanggan (nama_pelanggan, no_hp, email, alamat, tgl_daftar) VALUES
...
-- 2. MEKANIK
-- ============================================================
INSERT INTO mekanik (nama_mekanik, no_hp, spesialisasi, status_mekanik) VALUES
...
-- 3. KATEGORI_SERVIS
-- ============================================================
INSERT INTO kategori_servis (nama_kategori, deskripsi) VALUES
...
-- 4. SUPPLIER
-- ============================================================
INSERT INTO supplier (nama_supplier, no_hp, email, alamat) VALUES
...
-- 5. KENDARAAN
-- ============================================================
INSERT INTO kendaraan (id_pelanggan, no_polisi, merek, tipe, tahun, warna, jenis_transmisi, no_rangka, no_mesin) VALUES
...
-- 6. JASA_SERVIS
-- ============================================================
INSERT INTO jasa_servis (id_kategori, nama_jasa, deskripsi, biaya_jasa, estimasi_menit) VALUES
...
-- 7. SPAREPART
-- ============================================================
INSERT INTO sparepart (id_supplier, nama_sparepart, merek, satuan, stok, stok_minimum, harga_beli, harga_jual) VALUES
...
-- 8. TRANSAKSI_SERVIS
-- ============================================================
INSERT INTO transaksi_servis (id_kendaraan, id_mekanik, tanggal_masuk, tanggal_selesai, keluhan, status_servis) VALUES
...
-- ============================================================
INSERT INTO detail_jasa_servis (id_transaksi, id_jasa, biaya_jasa, qty, subtotal_jasa, catatan) VALUES
...
-- 10. DETAIL_SPAREPART
-- ============================================================
INSERT INTO detail_sparepart (id_transaksi, id_sparepart, jumlah, harga_satuan, subtotal_sparepart) VALUES
...
-- 11. INVOICE
-- ============================================================
INSERT INTO invoice (id_transaksi, tanggal_invoice, total_jasa, total_sparepart, total_tagihan, status_invoice) VALUES
(1,  '2024-01-08', 75000.00,   78000.00,  153000.00, 'lunas'),
(2,  '2024-01-10', 150000.00, 250000.00,  400000.00, 'lunas'),
(3,  '2024-01-15', 80000.00,   88000.00,  168000.00, 'lunas'),
(4,  '2024-01-20', 120000.00,  48000.00,  168000.00, 'lunas'),
(5,  '2024-02-05', 75000.00,   50000.00,  125000.00, 'lunas'),
(6,  '2024-02-10', 150000.00,  95000.00,  245000.00, 'lunas'),
(7,  '2024-02-14', 325000.00, 103000.00,  428000.00, 'lunas'),
(8,  '2024-02-20', 75000.00,   78000.00,  153000.00, 'lunas'),
(9,  '2024-03-01', 120000.00,  55000.00,  175000.00, 'lunas'),
(10, '2024-03-05', 50000.00,   50000.00,  100000.00, 'lunas'),
(11, '2024-03-12', 750000.00,  35000.00,  785000.00, 'sebagian'),
(12, '2024-03-18', 150000.00, 600000.00,  750000.00, 'lunas'),
(13, '2024-03-25', 350000.00, 190000.00,  540000.00, 'lunas'),
(14, '2024-04-02', 200000.00,  78000.00,  278000.00, 'lunas'),
(15, '2024-04-08', 50000.00,  140000.00,  190000.00, 'lunas'),
(16, '2024-04-15', 75000.00,   55000.00,  130000.00, 'lunas'),
(17, '2024-04-20', 225000.00,  50000.00,  275000.00, 'lunas'),
(18, '2024-05-03', 50000.00,   50000.00,  100000.00, 'lunas'),
(19, '2024-05-10', 60000.00,   42000.00,  102000.00, 'lunas'),
(20, '2024-05-15', 150000.00,  92000.00,  242000.00, 'lunas'),
(21, '2024-05-22', 175000.00, 110000.00,  285000.00, 'lunas'),
(22, '2024-06-01', 200000.00,  50000.00,  250000.00, 'lunas'),
(23, '2024-06-10', 75000.00,   78000.00,  153000.00, 'lunas');
-- ============================================================
-- 12. PEMBAYARAN
-- ============================================================
INSERT INTO pembayaran (id_invoice, tanggal_bayar, metode_pembayaran, jumlah_bayar) VALUES
...
SELECT
    ...
    (i.total_tagihan - COALESCE(SUM(pb.jumlah_bayar), 0)) AS sisa_tagihan
FROM invoice i
...
GROUP BY i.id_invoice, k.no_polisi, p.nama_pelanggan,
         ...
         i.total_tagihan, i.status_invoice
...
HAVING SUM(i.total_tagihan) > 500000
